        ...
        <FlexBetween px={2} py={1} flexWrap="wrap" key={ind} gap={1}>
          <FlexBox gap={2} alignItems="center">
            <Avatar variant="rounded" sx={{ height: 60, width: 60, backgroundColor: "grey.50" }}>
              <Image fill alt={item.productName} src={item.productImg || "/assets/images/products/placeholder.png"} sizes="(60px, 60px)" />
            </Avatar>
            ...
            <div>
              ...
              <Typography lineHeight={2} variant="body1" color="text.secondary">
                {currency(item.productPrice)} x {item.productQuantity}
              </Typography>
            </div>
          </FlexBox>
